...
#define ICM_20608G_ID   0xAF
#define ICM_20608D_ID   0xAE
/* ICM20608寄存器 
 *复位后所有寄存器地址都为0，除了
 ...
 * ICM20608结构体
 */
typedef struct _icm20608_dev_struc
{
...
extern icm20608_dev_struct icm20608_imu_data;
#define ICM20608_CSN(n)     (n==1?gpio_pin_write(GPIO1,20,1):gpio_pin_write(GPIO1,20,0))
